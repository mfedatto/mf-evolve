...
/// <summary>
///     Provides configuration, installation, and binding logic for the CLI
...
///     interfaces.
/// </summary>
public class CliContextBuilder
		...
		IContextBuilderConfigBinder
{
	...
	/// <summary>
	///     Binds the application configuration to the specified CLI
	///     configuration type.
	/// </summary>
	/// <param name="builder">
		...
		IConfiguration? configuration = null)
	{
		...
		CliConfig cliConfig =
			serviceProvider.GetService<CliConfig>()!;
